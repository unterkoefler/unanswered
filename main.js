...
var $author$project$PostList$all = _List_fromArray(
	[
		...
		'nest',
		{
			c9: $author$project$Generated$Nest$content,
			de: $elm$core$Maybe$Just(
				{df: 8, dN: 2, eQ: 2023}),
			dh: 'technology bad part 2',
			d9: true,
			eH: 'thank u, nest'
		}),
		_Utils_Tuple2(
		'batman',
		{
			c9: $author$project$Generated$Batman$content,
			de: $elm$core$Maybe$Just(
				{df: 18, dN: 4, eQ: 2023}),
			dh: 'Double Deckered Dilemmas',
			d9: true,
			eH: 'Batman’s NJ Transit Problem'
		}),
		_Utils_Tuple2(
		'aristotle',
		{
			c9: $author$project$Generated$Musings$content,
			de: $elm$core$Maybe$Just(
				{df: 30, dN: 4, eQ: 2023}),
			dh: 'Philosophical Musings',
			d9: true,
			eH: 'On Aristotle'
		}),
		_Utils_Tuple2(
		'itch',
		{
			c9: $author$project$Generated$Itch$content,
			de: $elm$core$Maybe$Just(
				{df: 18, dN: 5, eQ: 2023}),
			dh: 'A horror story',
			d9: true,
			eH: 'An Alternative to Benadryl'
		}),
		_Utils_Tuple2(
		'aliens',
		{
			c9: $author$project$Generated$Aliens$content,
			de: $elm$core$Maybe$Just(
				{df: 7, dN: 8, eQ: 2023}),
			dh: 'A short story about aliens and software engineering',
			d9: true,
			eH: 'WeComeInPeace'
		}),
		_Utils_Tuple2(
		'new-york',
		{
			c9: $author$project$Generated$NewYork$content,
			de: $elm$core$Maybe$Just(
				{df: 18, dN: 9, eQ: 2023}),
			dh: 'Stories from the Bigger Apple',
			d9: true,
			eH: 'Did I Move In Yet?: Vignettes'
		}),
		_Utils_Tuple2(
		'the-tide-rises',
		{
			c9: $author$project$Generated$Tide$content,
			de: $elm$core$Maybe$Just(
				{df: 27, dN: 11, eQ: 2023}),
			dh: 'A short story',
			d9: true,
...
var $author$project$Categories$categories = _List_fromArray(
	[
				...
				bs: _List_fromArray(
					[
						...
						t: $author$project$Categories$Slugs(
							{
								A: _List_fromArray(
									['the-hearse', 'crust', 'metaphor', 'arnold', 'batman'])
							}),
						w: 'Romance',
						o: 'romance'
					},
						...
						t: $author$project$Categories$Slugs(
							{
								A: _List_fromArray(
									['a-dangerous-hobby', 'bells', 'hell', 'hooked-mystery', 'hooked-solution', 'aliens'])
							}),
		...
		t: $author$project$Categories$Slugs(
			{
				A: _List_fromArray(
					['lost-and-not-found', 'think-like-a-squirrel', 'houseplant', 'beantown', 'the-boys-and-amazon', 'tech-support', 'four-stars', 'nest', 'aristotle'])
			}),
		w: 'Opinion',
		o: 'opinion'
	},
